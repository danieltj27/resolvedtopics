...
class ext extends \phpbb\extension\base {
	...
	public function enable_step( $old_state ) {
		...
		if ( false === $old_state ) {
			...
			$notifications->enable_notifications( 'danieltj.resolvedtopics.notification.type.resolved' );
	...
	public function disable_step( $old_state ) {
		...
		if ( false === $old_state ) {
			...
			$notifications->disable_notifications( 'danieltj.resolvedtopics.notification.type.resolved' );
	...
	public function purge_step( $old_state ) {
		...
		if ( false === $old_state ) {
			...
			$notifications->purge_notifications( 'danieltj.resolvedtopics.notification.type.resolved' );
